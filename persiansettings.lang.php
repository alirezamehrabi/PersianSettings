...
$l['setting_group_member_desc'] = 'در اینجا شما می توانید تنظیمات مختلف را در رابطه با ثبت نام کاربران و ورود آنها کنترل کنید.';

$l['setting_disableregs'] = 'غیرفعالسازی ثبت نام ها';
$l['setting_disableregs_desc'] = 'به شما اجازه می دهد تا قابلیت ثبت نام کاربران با یک کلیک را غیرفعال کنید.';
$l['setting_regtype'] = 'روش ثبت نام';
$l['setting_regtype_desc'] = 'لطفا روش نام نویسی مورد استفاده زمانی که کاربر ثبت نام می کند را انتخاب کنید.';
$l['setting_forcelogin'] = 'اجبار کاربران برای ورود';
$l['setting_forcelogin_desc'] = 'اگر این گزینه را بله انتخاب کنید مهمانان را اجبار می کند وارد شوند یا ثبت نام کنند تا به سایت دسترسی داشته باشند.';
$l['setting_minnamelength'] = 'کمترین طول حرف نام کاربری';
$l['setting_minnamelength_desc'] = 'حداقل تعداد حرف هایی که یک نام کاربری باید هنگام ثبت نام داشته باشد.';
$l['setting_maxnamelength'] = 'بیشترین طول حرف های نام کاربری';
$l['setting_maxnamelength_desc'] = 'حداکثر تعداد حرف هایی که یک نام کاربری هنگام ثبت نام می تواند داشته باشد.';
$l['setting_minpasswordlength'] = 'کمترین طول حرف های رمز عبور';
$l['setting_minpasswordlength_desc'] = 'حداقل طول حرف هایی که رمز عبور می تواند داشته باشد.';
$l['setting_maxpasswordlength'] = 'بیشترین طول حرف های رمز عبور';
$l['setting_maxpasswordlength_desc'] = 'حداکثر طول حرف هایی که رمز عبور می تواند داشته باشد.';
$l['setting_requirecomplexpasswords'] = 'پسورد پیچیده نیاز است؟';
$l['setting_requirecomplexpasswords_desc'] = 'آیا می خواهید کاربران از پسورد پیچیده استفاده کنند؟ پسورد پیچیده  نیاز به حرف بزرگ، حرف کوچک و عدد دارد.';
$l['setting_betweenregstime'] = 'زمان بین ثبت نام ها';
$l['setting_betweenregstime_desc'] = 'مقدار زمان (بر حسب ساعت) که اجازه ثبت نام داده نمی شود به کاربرانی که پیش از این با ip آی پی مشابه ثبت نام کرده اند.';
$l['setting_maxregsbetweentime'] = 'حداکثر عضویت با هر آدرس آی پی ip';
$l['setting_maxregsbetweentime_desc'] = 'این اختیار را به شما می دهد تا بیشترین بار هایی که کاربری خاص می تواند ثبت نام کند بدون در نظر گرفتن محدودیت زمانی که در گزینه بالا مشخص شده.';
$l['setting_allowmultipleemails'] = 'اجازه داده شود که با یک ایمیل بار ها ثبت نام شود؟';
$l['setting_allowmultipleemails_desc'] = 'بله را انتخاب کنید اگر می خواهید کاربران با یک ایمیل بار ها ثبت نام کنند در غیر اینصورت نه را انتخاب کنید.';
$l['setting_emailkeep'] = 'نگه داری ایمیل کاربران';
$l['setting_emailkeep_desc'] = 'اگر کاربر فعلی شما ایمیلی دارد که همچنین در لیست محرومین تان نیز قرار دارد، آیا آنها می توانند آن ایمیل را داشته باشند؟';
$l['setting_hiddencaptchaimage'] = 'نمایش یک تصویر امنیتی (hidden CAPTCHA)';
$l['setting_hiddencaptchaimage_desc'] = 'آیا شما می خواهید فیلد تصویر امنیتی CAPTCHAنمایش داده شود زمانی که یک کاربر ثبت نام می کند؟آنها ممکن است باعث جلوگیری از ثبت نام ربات های اسپم در انجمن تان شوند.';
$l['setting_hiddencaptchaimagefield'] = 'فیلد تصویر امنیتی CAPTCHA';
$l['setting_hiddencaptchaimagefield_desc'] = 'در زیر شما می توانید یک نام برای فیلد تصویر امنیتی CAPTCHA وارد کنید.';
$l['setting_usereferrals'] = 'استفاده از سیستم ارجاع دهنده';
$l['setting_usereferrals_desc'] = 'آیا می خواهید از سیستم ارجاع دهنده در این انجمن ها استفاده شود؟';
$l['setting_coppa'] = 'پذیرش Compliance';
$l['setting_coppa_desc'] = 'اگر شما می خواهید <a href="http://www.coppa.org/comply.htm"> کوپا</a>در انجمن تان فعال شود .لطفا اجازه ثبت نام را در زیر انتخاب کنید';
$l['setting_username_method'] = 'روش های ورود مجاز';
$l['setting_username_method_desc'] = 'روش های ورودی که می خواهید در فیلد نام کاربری مجاز باشند.فقط نام کاربری ، فقط ایمیل، هر دو مجازند.';
$l['setting_failedcaptchalogincount'] = 'تعداد ورود های ناموفق قبل از نیاز شدن به تاییدیه';
$l['setting_failedcaptchalogincount_desc'] = 'تعداد بار هایی که کاربر می تواند برای ورود تلاش کند قبل از اینکه نیاز به وارد کردن تاییدیه CAPTCHA شود. 0 برای غیر فعالسازی';
$l['setting_failedlogincount'] = 'تعداد بارهای مجاز برای ورود ناموفق';
$l['setting_failedlogincount_desc'] = 'تعداد دفعاتی که کاربر می تواند برای ورود تلاش کند. 0 برای غیرفعالسازی';
$l['setting_failedlogintime'] = 'زمانِ بین ورود های ناموفق';
$l['setting_failedlogintime_desc'] = 'مقدار زمانی که باید طول بکشد (بر حسب دقیقه) قبل از لینکه کاربر برای ورود مجدد تلاش کند، بعد از اینکه برای اولین بار نتوانست وارد شود.مورد استفاده قرار میگیرد اگر مقدار بالا صفر نباشد.';
$l['setting_failedlogintext'] = 'نمایش تعداد ورود های ناموفق';
$l['setting_failedlogintext_desc'] = 'آیا میخواهید در خطی نمایش داده شود چه تعداد بار های بیشتری فرد می تواند برای ورود تلاش کند؟';
$l['setting_regtime'] = 'حداقل زمانِ ثبت نام';
$l['setting_regtime_desc'] = 'حداقل زمان بر حسب ثانیه که کاربر باید ثبت نام را طول دهد. برای جلوگیری از ثبت نامِ خودکار ربات ها استفاده می شود.بر روی 0 قرار دهید تا این اختیار غیرفعال شود.';
$l['setting_securityquestion'] = 'نمایش سوال امنیتی';
$l['setting_securityquestion_desc'] = 'آیا می خواهید سوالی نمایش داده شود که کاربران باید آنرا هنگام ثبت نام جواب دهند؟';



$l['setting_group_profile'] = 'گزینه‌های پروفایل';
$l['setting_group_profile_desc'] = 'گزینه های اینجا تنظیمات مختلف پروفایل کاربران را در انجمن انجام می دهد.';
